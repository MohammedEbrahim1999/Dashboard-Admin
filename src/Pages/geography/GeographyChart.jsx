            ...
            : [
                {
                  ...
                  itemTextColor: theme.palette.mode==="dark"? theme.palette.info.dark : theme.palette.text.primary,
                  itemOpacity: 0.85,
                  symbolSize: 18,
                  effects: [
                    {
                      on: "hover",
                      style: {
                        itemTextColor: theme.palette.mode === "dark" ? theme.palette.info.dark: theme.palette.secondary.dark,
                        itemOpacity: 1,
                      },
                    },
                  ],
